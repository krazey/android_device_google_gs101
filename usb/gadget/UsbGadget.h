...
using ::android::hardware::google::pixel::usbaidl::addAdb;
using ::android::hardware::google::pixel::usbaidl::addEpollFd;
using ::android::hardware::google::pixel::usbaidl::getVendorFunctions;
using ::android::hardware::google::pixel::usbaidl::kDebug;
using ::android::hardware::google::pixel::usbaidl::kDisconnectWaitUs;
using ::android::hardware::google::pixel::usbaidl::linkFunction;
using ::android::hardware::google::pixel::usbaidl::MonitorFfsAidl;
using ::android::hardware::google::pixel::usbaidl::resetGadget;
using ::android::hardware::google::pixel::usbaidl::setVidPid;
using ::android::hardware::google::pixel::usbaidl::unlinkFunctions;
...
#endif
static MonitorFfsAidl monitorFfs(kGadgetName);
