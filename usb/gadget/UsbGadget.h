...
using ::android::hardware::google::pixel::usb_aidl::addAdb;
using ::android::hardware::google::pixel::usb_aidl::addEpollFd;
using ::android::hardware::google::pixel::usb_aidl::getVendorFunctions;
using ::android::hardware::google::pixel::usb_aidl::kDebug;
using ::android::hardware::google::pixel::usb_aidl::kDisconnectWaitUs;
using ::android::hardware::google::pixel::usb_aidl::linkFunction;
using ::android::hardware::google::pixel::usb_aidl::MonitorFfs;
using ::android::hardware::google::pixel::usb_aidl::resetGadget;
using ::android::hardware::google::pixel::usb_aidl::setVidPid;
using ::android::hardware::google::pixel::usb_aidl::unlinkFunctions;
